...
function readJsonSync(path, predicate) {
    return miscellany_1.parseJson(readFileSync(path), predicate);
}
exports.readJsonSync = readJsonSync;
async function readJson(path, predicate) {
    return miscellany_1.parseJson(await readFile(path), predicate);
}
exports.readJson = readJson;
async function tryReadJson(path, predicate) {
    return miscellany_1.tryParseJson(await readFile(path), predicate);
}
